  ...
  },
  {
    ...
    config = function()
      ...
      require('mason-lspconfig').setup {
        ensure_installed = {}, -- Add a list of LSP servers you want to ensure are installed
        automatic_installation = false, -- Set to true if you want Mason to auto-install missing LSP servers
        handlers = {
